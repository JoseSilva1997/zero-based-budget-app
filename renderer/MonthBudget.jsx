    ...
    <>
      <div className="section-head">
        ...
        <div className="income-total">
          <span className="income-total-label">Combined</span>
        ...
        {mo.incomes.map((inc) => {
          ...
          return (
            <div className="income-row income-grid" key={inc.id}>
              ...
              <TextInline value={inc.label} col="incomeLabel" label="Income source" onCommit={(v) => dispatch({ type: "updateIncome", month, id: inc.id, patch: { label: v } })} placeholder="Source" className="income-label" />
